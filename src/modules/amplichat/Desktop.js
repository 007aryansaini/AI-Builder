    ...
    <Col span={12}>
      ...
      >
        <Row justify="center" style={{ padding: "0px 50px" }}>
          <Typography.Title>yes</Typography.Title>
        </Row>
        <Row justify="center" style={{ padding: "0px 50px" }}>
          <Typography style={{ fontSize: "16px" }}>yes</Typography>
        </Row>
      </motion.div>
    </Col>
  );
...
function SectionItemImageOnTheRight(props) {
  return (
    ...
    >
      <Row justify="center" align="middle" style={{ maxWidth: "2000px" }}>
        <FloatTextCol title={props.sectionItem.title} text="jjjj" />
        <FloatImageCol image={props.sectionItem.image} />
      </Row>
    </Row>
  );
...
function Desktop() {
  ...
  const feautures = parsedContent.data.feautures;
      ...
      <Layout.Content>
        ...
        >
          <Row justify="center" align="middle" style={{ maxWidth: "2000px" }}>
            <Col style={{ width: "40%" }}>
              <Row justify="center" style={{ padding: "0px 50px" }}>
                <Typography.Title>{tagline}</Typography.Title>
              </Row>
        ...
        >
          <Row justify="center" align="middle" style={{ maxWidth: "2000px" }}>
            ...
            >
              <Row justify="center">
                <Typography.Title>{feautures}</Typography.Title>
              </Row>
              <Row justify="center">
                <Typography style={{ fontSize: "16px" }}>
                  {short_desc}
